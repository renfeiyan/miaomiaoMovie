<template>
<div id="detailsContainer" class="slider-enter-active">
...
<style scoped>
#detailsContainer{position:absolute; left: 0; top: 0; width:100%; min-height:100%;background: white; z-index: 500;}
#detailsContainer.slider-enter-active{animation :3 slideMovie}
